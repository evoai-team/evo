...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 EvoaiCoin from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 EvoaiCoin with subtract fee from amount
        ...
        # Sendmany 10 EvoaiCoin with subtract fee from amount
