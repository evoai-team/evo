...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 EvoaiCoin with
        the avoid_reuse flag set to false. This means the 10 EvoaiCoin send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 EvoaiCoin to A.
        [1] spends 5 EvoaiCoin from A. (leaving roughly 5 EvoaiCoin useable)
        [0] sends 10 EvoaiCoin to A again.
        [1] tries to spend 10 EvoaiCoin (fails; dirty).
        [1] tries to spend 4 EvoaiCoin (succeeds; change address sufficient)
        '''
