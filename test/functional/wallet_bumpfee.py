...
# Fee rates (in EvoaiCoin per 1000 vbytes)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 0.00350250 EvoaiCoin per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 EvoaiCoin / 1000 vbytes = 0.00049385 EvoaiCoin.
    # or occasionally 140 vbytes * fee_rate 0.00350250 EvoaiCoin / 1000 vbytes = 0.00049035 EvoaiCoin.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 EvoaiCoin.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 EvoaiCoin / 1000 vbytes = 0.00002820 EvoaiCoin
