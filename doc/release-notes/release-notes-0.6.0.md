...
Evoai-Qt can display and save QR codes for sending
...
Evoai-Qt's initial splash screen
...
opening/launching Evoai-Qt is available only on Linux,
and only if you configure your desktop to launch
Evoai-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Evoai-Qt window to start
payment.
...
It is expected that future releases of Evoai-Qt
