...
installer (on Windows) or just copy over /Applications/Evoai-Qt (on Mac) or
...
defaults to 0.00001. This will cause transactions with fewer EvoaiCoin/kB fee to be
...
- #6116 `30dc3c1` [OSX] rename Evoai-Qt.app to Bitcoin-Core.app
