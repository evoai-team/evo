...
- New `fees` field introduced in `getrawmempool`, `getmempoolancestors`, `getmempooldescendants` and
   ...
   and `descendant` denominated in EvoaiCoin. This new field deprecates previous fee fields, such as
...
- #12240 `6f8b345` Introduced a new `fees` structure that aggregates all sub-field fee types denominated in EvoaiCoin (mryandao)
