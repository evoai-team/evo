...
over /Applications/Evoai-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).
...
Using the standard "./autogen.sh; ./configure; make" to build Evoai-Qt and
...
0.1mEvoaiCoin per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mEvoaiCoin per kilobyte
