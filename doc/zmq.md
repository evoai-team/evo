...
during the *configure* step of building evoaid:
...
For instance:
    ...
    $ evoaid -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/evoaid.tx.raw \
...
From the perspective of evoaid, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into evoaid directly. Furthermore, no information is
