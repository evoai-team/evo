Contributing to EvoaiCoin Core
============================

The EvoaiCoin Core is based on the Bitcoin Core. The project operates an open
...
Whether a pull request is merged into EvoaiCoin Core rests with the project merge
...
Patches that change EvoaiCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the EvoaiCoin consensus, it must have been
...
The project leader is the release manager for each EvoaiCoin Core release.
