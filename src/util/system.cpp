...
const char * const BITCOIN_CONF_FILENAME = "evoai.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\evoai
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\evoai
    // Mac: ~/Library/Application Support/evoai
    // Unix: ~/.evoai
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "evoai";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/evoai";
#else
    // Unix
    return pathRet / ".evoai";
#endif
#endif
}
