...
public:
    CMainParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("00000161b843e58a183aa2f4ae730265c6e2f945c2c76c26862892dfe9dc29b2");
        ...
        consensus.nPowTargetTimespan = 1 * 60; // two weeks
        ...
        // Two days
        consensus.nASERTHalfLife = 30 * 24 * 60 * 60;
        ...
        genesis = CreateGenesisBlock(1748653200, 1473150, 0x1e0fffff, 1, 50 * COIN);
        ...
        vSeeds = {};
        vSeeds.emplace_back("156.233.233.173");
        vSeeds.emplace_back("156.253.13.190");
        vSeeds.emplace_back("156.253.9.177");
...
public:
    CTestNetParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("57dbf9a1c613d3cd22a99b9a8c8649f9e974cce9f9d5a9926ef93ff2c77251ab");
        ...
        genesis = CreateGenesisBlock(1747047625, 0, 0x207fffff, 1, 50 * COIN);
...
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("57dbf9a1c613d3cd22a99b9a8c8649f9e974cce9f9d5a9926ef93ff2c77251ab"));
        assert(genesis.hashMerkleRoot == uint256S("c4a47847658174dff39f23e69c2246e7e611752884ceb600694a8619adbbfef5"));
        ...
        checkpointData = {
            {
                {0, uint256S("57dbf9a1c613d3cd22a99b9a8c8649f9e974cce9f9d5a9926ef93ff2c77251ab")},
            }
        };
